...
class EmpleadoshinyunaWidget extends StatefulWidget {
  const EmpleadoshinyunaWidget({Key key}) : super(key: key);

  @override
  _EmpleadoshinyunaWidgetState createState() => _EmpleadoshinyunaWidgetState();
}

class _EmpleadoshinyunaWidgetState extends State<EmpleadoshinyunaWidget> {
