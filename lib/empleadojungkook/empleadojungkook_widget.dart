...
class EmpleadojungkookWidget extends StatefulWidget {
  const EmpleadojungkookWidget({Key key}) : super(key: key);

  @override
  _EmpleadojungkookWidgetState createState() => _EmpleadojungkookWidgetState();
}

class _EmpleadojungkookWidgetState extends State<EmpleadojungkookWidget> {
